                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="4" style="padding: 16px;">
                            ...
                            <p>
                                Thanks for joining Pamsha. Pamsha supports global businesses to efficiently manage, Click below button to login your account.
                            </p>
                            ...
                            <tr>
                                <td align="center" class="mobile" style="color: #fff; font-size: 12px;" valign="top" width="100%">
                                    <p style="margin: 0 0 10px 0">
                                        Copyright © {{ date('Y') }} {{ config('app.name') }}, All rights reserved. Powered By: Pamsha
                                    </p>
                                </td>
                            </tr>
                        </table>
