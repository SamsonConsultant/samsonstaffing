<div class="card-1 d-sm-flex align-items-center justify-content-between">
    ...
    <div class="d-flex">        
        <a href="{{ route('admin.page.create') }}" class="btn btn-Sub-Category"><i class="fa fa-plus" aria-hidden="true"></i> Add New Page</a>
    </div>
</div>

<div class="mt-3">
    @forelse($pages as $blog)
        <div class="card mb-3">
            <div class="row card-body">
                ...
                <div class="col-md-8">
                    ...
                    <div class="feature-card-deatails mt-3">
                        <div>
                            <a class="btn btn-back mr-2" href="{{ route('admin.page.edit', $blog['id']) }}"><i class="fa fa-edit"></i> Edit</a>
