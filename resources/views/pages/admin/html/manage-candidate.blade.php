<div class="wallet-balance-card-1 d-sm-flex align-items-center justify-content-between">
    <div>
        <h2>Manage Desired Candidate Profile</h2>
    </div>
</div>
            ...
            <div class="wallet-balance-card mt-2 p-3">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        ...
                        <input type="hidden" name="post_type" value="candidate_profile">
                    </div>
                </div>
                <div class="d-flex align-items-center mt-3">
                    <input type="hidden" name="post_id" value="{{ (isset($post)) ? $post->id : '' }}">
                    <input type="hidden" id="redirect_url" value="{{ route('admin.manage.candidate') }}">
                    ...
                    <tbody>
                        @forelse($posts as $post)
                            <tr data-entry-id="{{ $post['id'] }}">
                                ...
                                <td>
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.manage.candidate', $post['id']) }}">
