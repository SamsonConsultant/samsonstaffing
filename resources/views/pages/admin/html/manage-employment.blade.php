            ...
            <div class="wallet-balance-card mt-2 p-3">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        ...
                        <input type="hidden" name="post_type" value="employement_type">
                    </div>
                </div>
                <div class="d-flex align-items-center mt-3">
                    <input type="hidden" name="post_id" value="{{ (isset($post)) ? $post->id : '' }}">
                    <input type="hidden" id="redirect_url" value="{{ route('admin.manage.employment') }}">
                    ...
                    <tbody>
                        @forelse($posts as $post)
                            <tr data-entry-id="{{ $post['id'] }}">
                                ...
                                <td>
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.manage.employment', $post['id']) }}">
