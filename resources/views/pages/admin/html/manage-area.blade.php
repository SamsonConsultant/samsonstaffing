    	...
    	<form method="post" id="create-form" action="{{ route('admin.store.data') }}" enctype="multipart/form-data">
            <div class="wallet-balance-card mt-2 p-3">
                ...
                <div class="d-flex align-items-center mt-3">
                    ...
                    <input type="hidden" id="redirect_url" value="{{ route('admin.manage.area') }}">
                    ...
                    <tbody>
                        @forelse($posts as $post)
                            <tr data-entry-id="{{ $post['id'] }}">
                                ...
                                <td>
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.manage.area', $post['id']) }}">
