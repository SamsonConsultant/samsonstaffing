...
@section('content')
    ...
    @include('pages.employer.navigation', ['title' => 'Project Management'])
            ...
            <section class="overview-card-list dashboard-data-bg mt-4">
                <div class="overview-card-body">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('admin.store.bulk.mail') }}" method="post" id="send-bulk-mail" class="col-md-12 col-lg-12">
